...
export const resendUserOTPEmail = (username: string, otp: string | number) => {
    const subject = `Insert • Your new verification code, ${username}`;
...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en">
  ...
  <body>
    <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;">
      Here’s your new verification code for Insert.
    </div>
        ...
        <table role="presentation" width="100%">
          <tr>
            <td class="pad-32 text-center">
              <h1 style="margin:0 0 8px; font-size:22px; font-weight:700;">Your new verification code</h1>
              <p class="muted" style="font-size:15px; line-height:1.6; margin:0 0 16px;">
                Hey ${username}, you requested a new code. Use the latest code below to verify your email.
              </p>
              ...
              <p class="muted" style="font-size:12px; line-height:1.6; margin:14px 0 0;">
                This code expires in 5 minutes. If you receive multiple emails, use the most recent code. Do not share it with anyone.
              </p>
