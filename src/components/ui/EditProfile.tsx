...
const EditProfile = () => {
    ...
    const { updateUser, curr_user, uploadAvatar, curr_user_avatarURL } = useUser()

    const avatarURL = curr_user_avatarURL

    // console.log(session , curr_user)
    
    const [formData, setFormData] = useState({
        name: curr_user?.name as string,
        about: curr_user?.about as string,
        linkedin: curr_user?.linkedin as string,
        profile: curr_user?.profile as string,
        company: curr_user?.company as string,
        location: curr_user?.location as string,
    })
